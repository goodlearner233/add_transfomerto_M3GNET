...
class TestPotential:
    def test_potential_efsh(self, graph_MoS, model_tensornet):
    ...
    def test_potential_efsh_batch(self, graph_MoS, model_tensornet):
        # graph_MoS_list: list of (structure, graph, state) tuples
    ...
    def test_potential_efs(self, graph_MoS, model_tensornet):
        structure, graph, state = graph_MoS
        lat = torch.tensor(structure.lattice.matrix, dtype=matgl.float_th)
    ...
    def test_potential_ef(self, graph_MoS, model_tensornet):
        structure, graph, state = graph_MoS
        lat = torch.tensor(structure.lattice.matrix, dtype=matgl.float_th)
    ...
    def test_potential_e(self, graph_MoS, model_tensornet):
        structure, graph, state = graph_MoS
        lat = torch.tensor(structure.lattice.matrix, dtype=matgl.float_th)
    ...
    def test_including_repulsion(self, graph_MoS, model_tensornet):
        structure, graph, state = graph_MoS
        lat = torch.tensor(structure.lattice.matrix, dtype=matgl.float_th)
    ...
    def test_potential_efsh_with_force_fd(self, graph_MoS, model_tensornet):
    ...
    def test_forward_does_not_mutate_input_graph(self, graph_MoS, model_tensornet):
